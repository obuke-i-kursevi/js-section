...
addBookBtn.addEventListener('click', () => {
    addBook(bookNameInput.value, bookWritterInput.value, additionalAttributeNameInput.value, additionalAttibuteValueInput.value);
    clearFields();
});
...
const clearFields = () => {
    ...
    additionalAttibuteValueInput.value = '';
