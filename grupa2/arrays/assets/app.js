...
// ! SOME funkcija -> vraca true ako BAR JEDAN element iz niza zadovljava neki logicki uslov

console.log('Brojevi',brojevi);

const isBiggerThan10 = (element) => element > 10;

console.log('Array BROJEVI contains at least one number bigger than 10: ', brojevi.some(isBiggerThan10));
...
const findEvenNum = (element) => element % 2 === 0;

console.log('Array BROJEVI contains at least one element that is even: ', brojevi.some(findEvenNum));




// ! EVERY funkcija -> vraca true ako SVAKI element iz niza zadovljava neki logicki uslov

// * npr da li je SVAKI broj iz niza BROJEVI veci od 10

console.log('Array BROJEVI contains EACH number greater than 10:', brojevi.every(isBiggerThan10));




// ! FILL funkcija -> f-ja koja menja sve elemente u odredjenu vrednost. Pri tome, moze se zadati i pocetak i kraj dokle se menjaju vrednosti.

const randomNumbers = [100,200,300,400,500,600];

console.log('Fill funkcija', randomNumbers.fill(0,2));


console.log('Fill funkcija sa X', randomNumbers.fill('x'));
...
let fourNums = [4,10,12,14];

let addNumsRes = addNums(...fourNums);

console.log(`Spread operator result: ${addNumsRes}`); // 40


// * za kopiranje niza:

// * primer kopiranja niza koji sadrzi elemente primitivnih tipova
...
let maxValueNew = Math.max(...brojevi);

console.log(`Maximum value is ${maxValueNew}`); // 123
...
console.log(`Person's name is ${firstName} ${lastName} and is a student: ${isStudent}. Is old ${age} and has degree ${degree}`);
